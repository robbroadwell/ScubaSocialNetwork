  ...
  render() {
    ...
    return (
      <TouchableOpacity onPress={action} activeOpacity={1.0} style={{marginHorizontal: 5}} >
        <BaseHoverableView
          style={{ flexDirection: 'row', paddingVertical: 8, paddingHorizontal: 12, borderRadius: 8, shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.0, shadowRadius: 5, shadowColor: '#000', backgroundColor: this.props.popover ? "#21313C" : "FEFEFE", borderColor: this.props.selected ? '#555555' : '#cccccc', borderWidth: this.props.selected ? 2 : 1 }}
