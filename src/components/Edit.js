    ...
    return (
      <View style={{flex: 1}}>
        ...
        <View>
          ...
          {this.props.sourceAdd ? <View></View> :
            <TouchableOpacity style={{backgroundColor: '#A00000', margin: 5, flex: 1, borderRadius: 5}} onPress={this.props.closeEditing} >
              <Text style={{fontSize: 16, fontWeight: 'bold', textAlign: 'center', padding: 5, margin: 10, color: 'white'}}>Cancel</Text>
            </TouchableOpacity>
          }

            <TouchableOpacity style={{backgroundColor: '#A00000', margin: 5, flex: 1, borderRadius: 5}} onPress={this.onPressSubmit}>
