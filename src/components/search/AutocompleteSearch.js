...
const AutocompleteSearch = ({ header }) => {
  ...
  return (
    <View style={{position: 'absolute', width: '100%', alignItems: 'center'}}>
      ...
      <TextInput
        style={{width: '100%', outlineWidth: 0, paddingVertical: header ? 9 : 12, paddingHorizontal: 12, fontSize: header ? 16 : 18, color: header ? 'white' : 'black', borderColor: '#555555', borderWidth: header ? 1 : 0, backgroundColor: header ? '#20232a' : 'white', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.4, shadowRadius: 5, shadowColor: '#000', marginBottom: 0 }}
        spellCheck={false}
